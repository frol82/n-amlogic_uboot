...
#define CONFIG_IR_REMOTE_POWER_UP_KEY_VAL1 0xBF40FE01 //amlogic tv ir --- power  33 0xBF40FE01      tuopuli 0xe31cba04
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"upgrade_adc_key="\
            "saradc open 0; " \
        	"if saradc get_in_range 0 0x70; then " \
            "msleep 50; " \
            "if saradc get_in_range 0 0x70; then echo update by key...; run update; fi;" \
            "fi;"\
            "\0"\
